        ...
        PanelWindow {
            ...
            Item {
                ...
                Text {
                    ...
                    anchors.top: parent.top
                    anchors.right: parent.right
                    anchors.rightMargin: clockScope.vw * 13
                    anchors.topMargin: clockScope.vw * 0.5
                    text: Dat.Time.time
                    font.family: "Microsoft Yahei"
                    font.pixelSize: clockScope.vw * 5.5
                ...
                Text {
                    ...
                    anchors.right: parent.right
                    anchors.rightMargin: clockScope.vw * 10.5
                ...
                Text {
                    ...
                    anchors.right: parent.right
                    anchors.rightMargin: clockScope.vw * 7.4
                ...
                Text {
                    ...
                    anchors.right: parent.right
                    anchors.rightMargin: clockScope.vw * 6.9
